...
public class FlyFlower3D implements GLEventListener {
    ...
    public void display(GLAutoDrawable dr) { // clear the screen and draw the box
        ...
        for (int i = 0; i < 10; i++) {
            ...
            gl2.glColor3f(Color.pink.getRed() / 255f, Color.pink.getGreen() / 255f, Color.pink.getBlue() / 255f);
